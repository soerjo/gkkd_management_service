...
export class UpdateAdmin1704265318379 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."admin_role_enum" AS ENUM('SUPERADMIN', 'ADMIN', 'LEADER', 'PEMIMPIN_PERSEKUTUAN', 'PEMBIMBING')`);
        await queryRunner.query(`ALTER TABLE "admin" ADD "role" "public"."admin_role_enum" array NOT NULL DEFAULT '{ADMIN}'`);
    }
